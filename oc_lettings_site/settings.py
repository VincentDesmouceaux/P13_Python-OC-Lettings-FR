...
• Aucune erreur collectstatic même si un asset référencé n’existe pas
• WhiteNoise actif en PROD (storage sans manifest pour simplifier)
"""
...
DEBUG = (
    ...
    or (RUNSERVER and "DJANGO_DEBUG" not in os.environ)
    or RUNNING_TESTS
)
...
if PROD:
    # Pas de manifest → collectstatic jamais bloqué
    STORAGES = {
        "staticfiles": {
